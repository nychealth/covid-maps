...
function changeNeighborhood(zipCode) {
  ...
  document.getElementById("pbv").innerHTML = Number(
    zipVaxData[0].COUNT_BIVALENT_ADDITIONAL_CUMULATIVE
  ).toLocaleString("en-US");
  
  document.getElementById("vxrate").innerHTML = 
  ((zipVaxData[0].PERC_1PLUS > 100) ? 99 : zipVaxData[0].PERC_1PLUS) + "%";
...
//   }
  ...
  if (parentBoro === "Bronx") {
    document.getElementById("vboro").innerHTML = 
    ((boroVax[1].PERC_1PLUS > 100) ? 99 : boroVax[1].PERC_1PLUS) + "%";
    ...
    document.getElementById("vboro").innerHTML = 
    ((boroVax[2].PERC_1PLUS > 100) ? 99 : boroVax[2].PERC_1PLUS) + "%";
    ...
    document.getElementById("vboro").innerHTML = 
    ((boroVax[3].PERC_1PLUS > 100) ? 99 : boroVax[3].PERC_1PLUS) + "%";
    document.getElementById("boro3").innerHTML = parentBoro;
    // nested IF
    ...
    document.getElementById("vboro").innerHTML = 
    ((boroVax[4].PERC_1PLUS > 100) ? 99 : boroVax[4].PERC_1PLUS) + "%";
    document.getElementById("boro3").innerHTML = parentBoro;
    // nested IF
    ...
    document.getElementById("vboro").innerHTML = 
    ((boroVax[5].PERC_1PLUS > 100) ? 99 : boroVax[6].PERC_1PLUS) + "%";
...
function testMedians(x) {
  ...
  percB = Number(zipVaxData[0].PERC_BIVALENT_ADDITIONAL);
